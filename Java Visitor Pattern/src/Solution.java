 ...
 * how to parse the tree. The clue to solve it lies in the word "edge".
 * If we construct an undirected graph, and from the graph we obtain
 * the tree through a DFS (Deep First Search) the tree is easily
 * constructed. This was the code used to build the tree using DFS
 * 
 * This was 80% about figuring out the author's own concept
 * of what a tree is, 19% about building it, and 1% about the visitor pattern.
 * 
 * I am very unsatisfied with this problem  
 * 
 * */
